...
urlpatterns = [
    ...
    path('dashboard/project/task-view/<slug:project_id>/<slug:task_id>',view_task_details,name='view-taskdetail'),
    path('dashboard/project/task-view/<slug:project_id>/<slug:task_id>',edit_task,name='edit-tasks'),
